...
public enum HTTPStatusCode: Int, Error, LocalizedError {
    ...
    public var failureReason: String? {
        ...
        case .requestTimeout:  return "Time out"
        case .tooManyRequests: return "Too many requests"
        default:               return "Problems on request"
        }
    }
    
    public var errorDescription: String? {
        switch self {
        case .badRequest:      return "There were problems with the request, caused by some local error."
        case .unauthorized:    return "The user is not logged in or the current token has a problem."
        case .notFound:        return "The resorce cannot be found on the server. Try a different search."
        case .requestTimeout:  return "The request timed out"
        case .tooManyRequests: return "We’re sorry, but you have sent too many requests recently, Please try again later."
        default:               return "There were problems during the request."
        }
    }
}
